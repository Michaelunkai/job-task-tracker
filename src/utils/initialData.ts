...
export const initialProjects: Project[] = [
  { id: 'inbox', name: 'Inbox', color: '#3b82f6', order: 0, isArchived: false },
  { id: 'documentation', name: 'Documentation (Job)', color: '#10b981', order: 1, isArchived: false },
  { id: 'meetings', name: 'Meetings', color: '#f59e0b', order: 2, isArchived: false },
  { id: 'development', name: 'Development', color: '#8b5cf6', order: 3, isArchived: false },
  { id: 'admin', name: 'Administrative', color: '#ef4444', order: 4, isArchived: false },
];
